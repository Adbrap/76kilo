...
th10 = Process(target=Finder_IETE, args=(1,heure,start_1h))
th11 = Process(target=Finder_IETE, args=(75,minute,start_1h))
th12 = Process(target=Finder_IETE, args=(90,minute,start_1h))
th13 = Process(target=Finder_IETE, args=(105,minute,start_1h))
th14 = Process(target=Finder_IETE, args=(2,heure,start_1h))
th15 = Process(target=Finder_IETE, args=(135,minute,start_1h))
th16 = Process(target=Finder_IETE, args=(150,minute,start_1h))
th17 = Process(target=Finder_IETE, args=(165,minute,start_1h))
th18 = Process(target=Finder_IETE, args=(3,heure,start_1h))
th19 = Process(target=Finder_IETE, args=(195,minute,start_1h))
th20 = Process(target=Finder_IETE, args=(210,minute,start_1h))
th21 = Process(target=Finder_IETE, args=(225,minute,start_1h))
th22 = Process(target=Finder_IETE, args=(4,heure,start_1h))
